...
expected_answer_async = (
    "Your report for report-test-1.txt is ready to view.\n\n"
    "The following materiality topics were identified for "
    "CompanyABC which the report focuses on:\n\n"
    "topic1\ntopic1 description\n\n"
    "topic2\ntopic2 description"
)
expected_answer_sync = (
    "Your report for report-test-2.txt is ready to view.\n\n"
    "The following materiality topics were identified for "
    "CompanyABC which the report focuses on:\n\n"
    "topic1\ntopic1 description\n\n"
    "topic2\ntopic2 description"
...
async def test_prepare_file_for_report(mocker):
    ...
    session_file = FileUpload(id=str(mock_id), filename=filename, upload_id=None, content=None)
